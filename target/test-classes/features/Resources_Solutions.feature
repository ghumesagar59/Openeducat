	Feature: Automation Resources, Solutions and sub option on OpenEduCat
	
	Scenario: Automation Resources and sub option
...
Scenario: Automation Solutions and sub option
